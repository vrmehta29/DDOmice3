...
for filename in filelist:
	...
	for i in range(len(pointsdata)):
		# hf = h5py.File('/projects/kumar-lab/mehtav/normalised_vd_tail_h5/'+ filename[:-3] + str(i) + '_vvd.h5', 'w')
		hf = h5py.File('/gpfs/ctgs0/home/c-mehtav/DDOmice2/temp/'+ filename[:-3] + str(i) + '_vvd.h5', 'w')
		hf.create_dataset('points', data=pointsdata[i])
		hf.create_dataset('confidence', data=confdata[i])
		hf.create_dataset('velocity', data=velocityvectordata[i])
		hf.close()
